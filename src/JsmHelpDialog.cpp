...
static const OpcodeHelp opcodeHelpData[] = {
	...
	{"dirp", "Positioning", "dirp(targetX, targetY, targetZ)", "Turn to face a world point (X,Y,Z). Not a party slot despite the name; use pdira to face a party member."},
	...
	{"move", "Movement", "move(x, y, z, moveAngle)", "Walk/run to X,Y,Z, ending at the given facing angle."},
	{"movea", "Movement", "movea(actorID, moveAngle)", "Move towards actor."},
	{"pmovea", "Movement", "pmovea(partyMemberID, moveAngle)", "Move towards party member."},
	{"cmove", "Movement", "cmove(x, y, z, moveAngle)", "Move to X,Y,Z without animation or turning."},
	{"fmove", "Movement", "fmove(x, y, z, moveAngle)", "Move to X,Y,Z without animation, facing the direction of travel."},
	...
	{"pjumpa", "Movement", "pjumpa(partyMemberID, jumpDurationFrames)", "Jump to party member over the given number of frames."},
	...
	{"rmove", "Movement", "rmove(x, y, z, moveAngle)", "Resume-script move (no pause)."},
	{"rmovea", "Movement", "rmovea(actorID, moveAngle)", "Resume-script move to actor."},
	{"rpmovea", "Movement", "rpmovea(partyMemberID, moveAngle)", "Resume-script move to party member."},
	{"rcmove", "Movement", "rcmove(x, y, z, moveAngle)", "Resume-script cmove."},
	{"rfmove", "Movement", "rfmove(x, y, z, moveAngle)", "Resume-script fmove."},
	{"fmovea", "Movement", "fmovea(actorID, moveAngle)", "Face-move to actor."},
	{"fmovep", "Movement", "fmovep(partyMemberID, moveAngle)", "Face-move to party member."},
	...
	{"aask", "Messages", "aask(channel, textID, first, last, default, cancel, x, y)", "Positioned choices. Result in temp_0."},
	{"setmesspeed", "Messages", "setmesspeed(channel, speed)", "Set text speed for a message channel."},
	...
	{"mapjumpo", "Map Transitions", "mapjumpo(fieldMapID, walkmeshID)", "Jump to field, spawn on given walkmesh triangle (usually 0). For cutscenes."},
	...
	// -- Unknown --
	{"unknown2", "Unknown", "unknown2()", "Head pose: tilt head down (inline arg 0/1/2 = straight/right/left), over 30 frames."},
	{"unknown3", "Unknown", "unknown3()", "Head pose: tilt head up (inline arg 0/1/2 = straight/right/left), over 30 frames."},
	{"unknown4", "Unknown", "unknown4()", "Set the entity \"move without walkmesh clipping\" flag from the stack (used on the Ragnarok hatch)."},
	{"clockwiseturn", "Turning", "clockwiseturn()", "Turn clockwise."},
	{"counterclockwiseturn", "Turning", "counterclockwiseturn()", "Turn counter-clockwise."},
	{"clockwiseturn2", "Turning", "clockwiseturn2()", "Turn clockwise (variant 2)."},
	{"counterclockwiseturn2", "Turning", "counterclockwiseturn2()", "Turn counter-clockwise (variant 2)."},
	{"unknown10", "Unknown", "unknown10()", "PC no-op stub (queried music status on PSX); returns 0."},
	{"unknown11", "Unknown", "unknown11()", "Turn to face a party character at the given speed."},
	{"unknown12", "Unknown", "unknown12()", "Sync-wait until the unknown11 turn finishes."},
	{"unknown13", "Unknown", "unknown13()", "Pop one value; returns the sound-effect attribute check in temp_0."},
	{"preservesoundchannel", "Sound", "preservesoundchannel()", "Preserve sound channel across field loads."},
	{"unknown15", "Unknown", "unknown15()", "Set the jump-duration divisor (default 28) used by jump/jump3."},
	{"setdrawpointid", "Items", "setdrawpointid()", "Set the draw point ID."},
