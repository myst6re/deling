...
void MsdWidget::build()
{
	...
	action = toolBar->addAction(QIcon(":/images/icon-squall.png"), dataNames.at(0));
	action->setData("{Squall}");
	action = toolBar->addAction(QIcon(":/images/icon-rinoa.png"), dataNames.at(4));
	action->setData("{Rinoa}");
	action = toolBar->addAction(QIcon(":/images/icon-quistis.png"), dataNames.at(3));
	action->setData("{Quistis}");
	action = toolBar->addAction(QIcon(":/images/icon-zell.png"), dataNames.at(1));
	action->setData("{Zell}");
	action = toolBar->addAction(QIcon(":/images/icon-selphie.png"), dataNames.at(5));
	action->setData("{Selphie}");
	action = toolBar->addAction(QIcon(":/images/icon-irvine.png"), dataNames.at(2));
	action->setData("{Irvine}");
	action = toolBar->addAction(QIcon(":/images/icon-seifer.png"), dataNames.at(6));
	action->setData("{Seifer}");
	action = toolBar->addAction(QIcon(":/images/icon-edea.png"), dataNames.at(7));
	action->setData("{Edea}");
	action = toolBar->addAction(QIcon(":/images/icon-laguna.png"), dataNames.at(8));
	action->setData("{Laguna}");
	action = toolBar->addAction(QIcon(":/images/icon-kiros.png"), dataNames.at(9));
	action->setData("{Kiros}");
	action = toolBar->addAction(QIcon(":/images/icon-ward.png"), dataNames.at(10));
	action->setData("{Ward}");
	action = toolBar->addAction(QIcon(":/images/icon-angelo.png"), dataNames.at(15));
	action->setData("{Angelo}");
	action = toolBar->addAction(QIcon(":/images/icon-griever.png"), dataNames.at(12));
	action->setData("{Griever}");
	action = toolBar->addAction(QIcon(":/images/icon-boko.png"), dataNames.at(14));
	action->setData("{Boko}");
	...
	action = toolBar2->addAction(QIcon(":/images/icon-char-1.png"), FF8Text::caract(0x30));
	action->setData(FF8Text::caract(0x30));
	action = toolBar2->addAction(QIcon(":/images/icon-char-2.png"), FF8Text::caract(0x3a));
	action->setData(FF8Text::caract(0x3a));
	action = toolBar2->addAction(QIcon(":/images/icon-char-3.png"), FF8Text::caract(0x3e));
	action->setData(FF8Text::caract(0x3e));
	action = toolBar2->addAction(QIcon(":/images/icon-char-4.png"), FF8Text::caract(0x3f));
	action->setData(FF8Text::caract(0x3f));
	action = toolBar2->addAction(QIcon(":/images/icon-char-5.png"), FF8Text::caract(0x40));
	action->setData(FF8Text::caract(0x40));
	action = toolBar2->addAction(QIcon(":/images/icon-char-6.png"), "{xa8}");
	action->setData("{xa8}");
	action = toolBar2->addAction(QIcon(":/images/icon-char-7.png"), FF8Text::caract(0xab));
	action->setData(FF8Text::caract(0xab));
	action = toolBar2->addAction(QIcon(":/images/icon-char-8.png"), FF8Text::caract(0xac));
	action->setData(FF8Text::caract(0xac));
	action = toolBar2->addAction(QIcon(":/images/icon-char-9.png"), FF8Text::caract(0xad));
	action->setData(FF8Text::caract(0xad));
	action = toolBar2->addAction(QIcon(":/images/icon-char-10.png"), FF8Text::caract(0xae));
	action->setData(FF8Text::caract(0xae));
	action = toolBar2->addAction(QIcon(":/images/icon-char-11.png"), FF8Text::caract(0xaf));
	action->setData(FF8Text::caract(0xaf));
	action = toolBar2->addAction(QIcon(":/images/icon-char-12.png"), FF8Text::caract(0xb0));
	action->setData(FF8Text::caract(0xb0));
	action = toolBar2->addAction(QIcon(":/images/icon-char-13.png"), "{xb1}");
	action->setData("{xb1}");
	action = toolBar2->addAction(QIcon(":/images/icon-char-14.png"), FF8Text::caract(0xb2));
	action->setData(FF8Text::caract(0xb2));
	action = toolBar2->addAction(QIcon(":/images/icon-char-15.png"), FF8Text::caract(0xb3));
	action->setData(FF8Text::caract(0xb3));
	action = toolBar2->addAction(QIcon(":/images/icon-char-16.png"), "{xb4}");
	action->setData("{xb4}");
	action = toolBar2->addAction(QIcon(":/images/icon-char-17.png"), "{xb6}");
	action->setData("{xb6}");
	action = toolBar2->addAction(QIcon(":/images/icon-char-18.png"), FF8Text::caract(0xb7));
	action->setData(FF8Text::caract(0xb7));
	action = toolBar2->addAction(QIcon(":/images/icon-char-19.png"), FF8Text::caract(0xb8));
	action->setData(FF8Text::caract(0xb8));
	action = toolBar2->addAction(QIcon(":/images/icon-char-20.png"), "{xb9}");
	action->setData("{xb9}");
	action = toolBar2->addAction(QIcon(":/images/icon-char-21.png"), "{xba}");
	action->setData("{xba}");
	action = toolBar2->addAction(QIcon(":/images/icon-char-22.png"), FF8Text::caract(0xbb));
	action->setData(FF8Text::caract(0xbb));
	action = toolBar2->addAction(QIcon(":/images/icon-char-23.png"), FF8Text::caract(0xbf));
	action->setData(FF8Text::caract(0xbf));
	action = toolBar2->addAction(QIcon(":/images/icon-char-24.png"), FF8Text::caract(0xc0));
	action->setData(FF8Text::caract(0xc0));
	action = toolBar2->addAction(QIcon(":/images/icon-char-25.png"), FF8Text::caract(0xc1));
	action->setData(FF8Text::caract(0xc1));
	action = toolBar2->addAction(QIcon(":/images/icon-char-26.png"), FF8Text::caract(0xc2));
	action->setData(FF8Text::caract(0xc2));
	action = toolBar2->addAction(QIcon(":/images/icon-char-27.png"), FF8Text::caract(0xc3));
	action->setData(FF8Text::caract(0xc3));
	action = toolBar2->addAction(QIcon(":/images/icon-char-28.png"), FF8Text::caract(0xc5));
	action->setData(FF8Text::caract(0xc5));
	action = toolBar2->addAction(QIcon(":/images/icon-char-29.png"), "{xc6}");
	action->setData("{xc6}");
	action = toolBar2->addAction(QIcon(":/images/icon-char-30.png"), "{xc7}");
	action->setData("{xc7}");
	action = toolBar2->addAction(QIcon(":/images/icon-char-31.png"), FF8Text::caract(0xc9));
	action->setData(FF8Text::caract(0xc9));
