...
void MsdWidget::build()
{
	...
	action = toolBar->addAction(QIcon(":/images/icon-squall.png"), Data::names[0]);
	action->setData("{Squall}");
	action = toolBar->addAction(QIcon(":/images/icon-rinoa.png"), Data::names[4]);
	action->setData("{Rinoa}");
	action = toolBar->addAction(QIcon(":/images/icon-quistis.png"), Data::names[3]);
	action->setData("{Quistis}");
	action = toolBar->addAction(QIcon(":/images/icon-zell.png"), Data::names[1]);
	action->setData("{Zell}");
	action = toolBar->addAction(QIcon(":/images/icon-selphie.png"), Data::names[5]);
	action->setData("{Selphie}");
	action = toolBar->addAction(QIcon(":/images/icon-irvine.png"), Data::names[2]);
	action->setData("{Irvine}");
	action = toolBar->addAction(QIcon(":/images/icon-seifer.png"), Data::names[6]);
	action->setData("{Seifer}");
	action = toolBar->addAction(QIcon(":/images/icon-edea.png"), Data::names[7]);
	action->setData("{Edea}");
	action = toolBar->addAction(QIcon(":/images/icon-laguna.png"), Data::names[8]);
	action->setData("{Laguna}");
	action = toolBar->addAction(QIcon(":/images/icon-kiros.png"), Data::names[9]);
	action->setData("{Kiros}");
	action = toolBar->addAction(QIcon(":/images/icon-ward.png"), Data::names[10]);
	action->setData("{Ward}");
	action = toolBar->addAction(QIcon(":/images/icon-angelo.png"), Data::names[15]);
	action->setData("{Angelo}");
	action = toolBar->addAction(QIcon(":/images/icon-griever.png"), Data::names[12]);
	action->setData("{Griever}");
	action = toolBar->addAction(QIcon(":/images/icon-boko.png"), Data::names[14]);
	action->setData("{Boko}");
