...
void JsmWidget::build()
{
	...
	warningWidget = new QLabel(tr("Attention : Les scripts de cet �cran sont dans un ancien format mal reconnu par Deling. Ce que vous pourrez lire ici n'aura peut-�tre aucun sens."), this);
	warningWidget->hide();
